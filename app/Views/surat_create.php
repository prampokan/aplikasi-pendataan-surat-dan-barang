                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="no_surat"></input>
                                    </div>
                                    <div class="mb-3">
                                        <label for="firstNameinput" class="form-label">Nama surat</label>
                                        <input type="text" class="form-control" name="nm_surat"></input>
                                    </div>
                                    <div class="mb-3">
                                        <label for="firstNameinput" class="form-label">Pengirim</label>
                                        <input type="text" class="form-control" name="pengirim"></input>
                                    </div>
                                    <div class="mb-3">
                                        <label for="firstNameinput" class="form-label">Nama Penerima</label>
                                        <select class="form-select mb-3" name="id_penerima" aria-label="Default select example" id="suratKaryawan"></select>
                                    </div>
                                    <div class="mb-3">
